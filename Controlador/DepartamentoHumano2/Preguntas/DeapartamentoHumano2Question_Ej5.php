...
<?php if($esVisual): ?>
  ...
  <div class="ejercicio">
    ...
    <p>
      <strong>Indicación:</strong> A continuación, le voy a presentar dos palabras Ud. deberá analizar que semejanza existen entre las dos y elegir la opción que usted considere correcta.
    </p>
    <p>¿En qué se parecen los aguantes y el casco?</p>
    <div class="pregunta">
      <div class="opcion">
        <label>
...
<div class="simbolos-container">
  ...
  <input type="number" id="busquedaMenor" placeholder="8" name="busquedaMenor" min="0" step="1" required>
