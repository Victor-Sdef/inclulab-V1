...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    insertRespuesta($pdo, $id_usuario, $departamento, $cargo_laboral, 5, "Ejercicio 5: Búsqueda de Símbolos", $contextoEjercicio, "Cuenta los símbolos en la imagen", $simbolosRespuesta, $discapacidad, $evalE5_2);
