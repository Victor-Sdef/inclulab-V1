...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento de Producción 2 (Operario General)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoDepartamento" value="Departamento de Producción 2">
      <input type="hidden" name="prefijoCargo" value="Operario General">
      ...
      <?php 
         ...
         include '../../../../Controlador/DepartamentoDeProduccion2/Preguntas/DepartamentoDeProduccion2Question_Ej1.php'; 
         include '../../../../Controlador/DepartamentoDeProduccion2/Preguntas/DepartamentoDeProduccion2Question_Ej2.php'; 
         //include '../../../../Controlador/DepartamentoDeProduccion2/Preguntas/DepartamentoDeProduccion2Question_Ej3.php'; 
         include '../../../../Controlador/DepartamentoDeProduccion2/Preguntas/DepartamentoDeProduccion2Question_Ej4.php'; 
         include '../../../../Controlador/DepartamentoDeProduccion2/Preguntas/DepartamentoDeProduccion2Question_Ej5.php'; 
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoDeProduccion2Ecuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
