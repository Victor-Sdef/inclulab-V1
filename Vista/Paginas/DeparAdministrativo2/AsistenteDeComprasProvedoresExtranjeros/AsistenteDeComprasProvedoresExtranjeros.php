...
<h2>Bienvenido/a, <?php echo htmlspecialchars($nombreUsuario); ?></h2>
  <br>
  <h1>Evaluación - Departamento Administrativo 2 (Asistente de compra de Provedores Extranjeros)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Asistente de compra de Provedores Extranjeros">
