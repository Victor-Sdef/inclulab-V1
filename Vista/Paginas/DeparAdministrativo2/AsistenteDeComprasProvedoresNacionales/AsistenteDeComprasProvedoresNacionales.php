...
<head>
  <meta charset="UTF-8">
  <title>Evaluación - Administrativo 2</title>
...
<br>
  <h1>Evaluación - Departamento Administrativo 2 ( Asistente de compras de provedores Nacionales )</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoDepartamento" value="Departamento Administrativo 2">
      <input type="hidden" name="prefijoCargo" value="Asistente de compras de provedores Nacionales">
      ...
      <?php 
         ...
         include '../../../../Controlador/DepartamentoAdministrativo2/Preguntas/DepartamentoAdministrativo2Question12345.php'; 
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoAdministrativo2Encuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
