...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias(Departamento Administrativo2)</title>
...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento Administrativo 2)</h1>
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento Administrativo 2">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento Administrativo 2">
            <table>
                <thead>
                    <tr>
                        <th>Competencia</th>
