<?php
  ...
  <head>
    <meta charset="UTF-8">
    <title>Evaluación - Departamento de Talento Humano 2</title>
...
<div class="header-container1">
  ...
  <br>
    <h1>Encuesta - Departamento de Talento Humano(Mensajero)</h1>
    ...
    <div class="form-container">
     ...
     <input type="hidden" name="prefijoDepartamento" value="Departamento de Talento Humano 4">
        <input type="hidden" name="prefijoCargo" value="Mensajero">
        <input type="hidden" name="prefijoDiscapacidad" value="auditiva, visual, fisica, intelectual">
