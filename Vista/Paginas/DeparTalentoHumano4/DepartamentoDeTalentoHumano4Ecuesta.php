...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento de Talento Humano)</h1>
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento de Talento Humano 4">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento de Talento Humano 4">
            <table>
                <thead>
                    <tr>
                        <th>Competencia</th>
