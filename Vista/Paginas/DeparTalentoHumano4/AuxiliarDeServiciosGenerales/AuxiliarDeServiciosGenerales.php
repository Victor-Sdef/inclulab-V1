  ...
  <link rel="stylesheet" href="../../../assets/css/DepartamentoDeTalentoHumano4/DepartamentoDeTalentoHumano4.css">
...
<div class="header-container1">
 ...
 <h2>Bienvenido/a, <?php echo htmlspecialchars($nombreUsuario); ?></h2>
  <br>
    <h1>para Departamento de Talento Humano(Auxiliar De Servicios Generales)</h1>
    ...
    <div class="form-container">
      ...
      <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
        ...
        <input type="hidden" name="prefijoDepartamento" value="Departamento de Talento Humano 4">
        <input type="hidden" name="prefijoCargo" value="Auxiliar De Servicios Generales">
        <input type="hidden" name="prefijoDiscapacidad" value="auditiva, visual, fisica">
        ...
        <?php 
          ...
          include '../../../../Controlador/DepartamentoHumano4/Preguntas/DeapartamentoHumano4Question_Ej1.php'; 
          include '../../../../Controlador/DepartamentoHumano4/Preguntas/DeapartamentoHumano4Question_Ej2.php'; 
          include '../../../../Controlador/DepartamentoHumano4/Preguntas/DeapartamentoHumano4Question_Ej3.php'; 
          include '../../../../Controlador/DepartamentoHumano4/Preguntas/DeapartamentoHumano4Question_Ej4.php'; 
          include '../../../../Controlador/DepartamentoHumano4/Preguntas/DeapartamentoHumano4Question_Ej5.php'; 
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoDeTalentoHumano4Ecuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
...
<script src="../../../assets/js/DepartamentoDeTalentoHumano4/DepartamentoDeTalentoHumano4.js"></script>
