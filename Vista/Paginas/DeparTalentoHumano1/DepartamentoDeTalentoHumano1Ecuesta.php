...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias Departamento De Talento Humano 1</title>
...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento de Talento Humano 1)</h1>
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento de Talento Humano 1">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento de Talento Humano 1">
