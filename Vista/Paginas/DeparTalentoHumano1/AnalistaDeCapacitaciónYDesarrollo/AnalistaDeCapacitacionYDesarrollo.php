<?php
// AnalistaDeCapacitacionYDesarrollo.php
session_start();
...
<head>
  <meta charset="UTF-8">
  <title>Evaluación de Competencias para el Departamento De Talento Humano1</title>

</head>
<link rel="stylesheet" href="../../../assets/css/DepartamentoDeTalentoHumano1/DepartamentoDeTalentoHumano1.css">
...
<div class="header-container1">
 ...
 <h2>Bienvenido/a, <?php echo htmlspecialchars($nombreUsuario); ?></h2>
  <br>
  <h1>Evaluación - Departamento de Talento Humano 1 (Analista De Capacitación Y Desarrollo)</h1>
 
  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
    
      <input type="hidden" name="prefijoDepartamento" value="Departamento de Talento Humano 1">
      <input type="hidden" name="prefijoCargo" value="Analista De Capacitación Y Desarrollo">
      <input type="hidden" name="prefijoDiscapacidad" value="fisica">


      <?php include '../../../../Controlador/DepartamentoHumano1/Preguntas/AnalistaDeTalentoHumanoQuestion.php'; ?>
...
<script src="../../../assets/js/DepartamentoDeTalentoHumano1/DepartamentoDeTalentoHumano1.js"></script>
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoDeTalentoHumano1Ecuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
