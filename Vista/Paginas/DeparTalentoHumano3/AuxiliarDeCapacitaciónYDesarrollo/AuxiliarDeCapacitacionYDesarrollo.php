...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento de Talento Humano (Auxiliar De Capacitación Y Desarrollo")</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Auxiliar De Capacitación Y Desarrollo">
      <input type="hidden" name="prefijoDiscapacidad" value="fisica">
