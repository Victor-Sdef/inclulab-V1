...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias Departamento De Talento Humano</title>
...
<body>
    <div class="survey-container">
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento de Talento Humano 3">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento de Talento Humano 3">
            <table>
                <thead>
                    <tr>
                        <th>Competencia</th>
