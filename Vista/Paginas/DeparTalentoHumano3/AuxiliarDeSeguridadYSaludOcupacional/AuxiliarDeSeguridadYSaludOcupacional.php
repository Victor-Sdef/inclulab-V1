...
<head>
  <meta charset="UTF-8">
  <title>Evaluación - Departamento de Talento Humano</title>

</head>
<link rel="stylesheet" href="../../../assets/css/DepartamentoDeTalentoHumano3/DepartamentoDeTalentoHumano3.css">
...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento de Talento Humano(Auxiliar De Seguridad y Salud Ocupacional")</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoDepartamento" value="Departamento de Talento Humano 3">
      <input type="hidden" name="prefijoCargo" value="Auxiliar De Seguridad Y Salud Ocupacional">
      <input type="hidden" name="prefijoDiscapacidad" value="fisica, auditiva">
      ...
      <?php 
         ...
         include '../../../../Controlador/DepartamentoHumano3/Preguntas/DeapartamentoHumano3Question_Ej1.php'; 
         include '../../../../Controlador/DepartamentoHumano3/Preguntas/DeapartamentoHumano3Question_Ej2.php'; 
         include '../../../../Controlador/DepartamentoHumano3/Preguntas/DeapartamentoHumano3Question_Ej3.php'; 
         include '../../../../Controlador/DepartamentoHumano3/Preguntas/DeapartamentoHumano3Question_Ej4.php'; 
         include '../../../../Controlador/DepartamentoHumano3/Preguntas/DeapartamentoHumano3Question_Ej5.php'; 
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoDeTalentoHumano3Ecuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
<!-- Tus dos archivos JS separados -->
<script src="../../../assets/js/Inicio/accesibilidad.js"></script>

<script src="../../../assets/js/DepartamentoDeTalentoHumano3/DepartamentoDeTalentoHumano3.js"></script>
