...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias(Departamento Comercial)</title>
...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento Comercial)</h1>
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento Comercial">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento Comercial">
