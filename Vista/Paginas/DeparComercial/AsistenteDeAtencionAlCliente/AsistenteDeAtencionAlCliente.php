...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento Comercial (Asistente de atencion al cliente)</h1>
  
  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
    
      <input type="hidden" name="prefijoDepartamento" value="Departamento Comercial">
      <input type="hidden" name="prefijoCargo" value="Asistente de atencion al cliente">
      <input type="hidden" name="prefijoDiscapacidad" value="fisica,visual y auditiva">


      <?php include '../../../../Controlador/DepartamentoComercial/Preguntas/DepartamentoComercialQuestion.php'; ?>
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoComercialEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
...
<script src="../../../assets/js/DepartamentoComercial/DepartamentoComercial.js"></script>
</body>
