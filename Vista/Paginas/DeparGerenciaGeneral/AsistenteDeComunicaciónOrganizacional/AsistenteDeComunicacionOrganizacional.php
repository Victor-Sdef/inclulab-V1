...
<br> 
  <h1>Evaluación - Departamento Gerencia General (Asistente De Comunicación Organizacional)</h1>
  ...
  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Asistente De Comunicación Organizacional">
...
<style>
  ...
  #realizarEncuesta {
    ...
    z-index: 1000; /* Asegura que el botón esté encima de otros element   os */
  }
</style>
...
<script>
  function abrirEncuesta() {
    ...
    window.open('AsistenteDeComunicacionOrganizacionalEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
