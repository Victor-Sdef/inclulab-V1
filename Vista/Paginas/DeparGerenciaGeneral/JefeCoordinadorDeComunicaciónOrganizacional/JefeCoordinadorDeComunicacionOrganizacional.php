...
<head>
  <meta charset="UTF-8">
  <title>Evaluación de Competencias -Departamento De Gerencia General</title>
...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento Gerencia General (Jefe Coordinador De Comunicación Organizacional)</h1>
...
<input type="hidden" name="prefijoDepartamento" value="Departamento de Gerencia General">
      <input type="hidden" name="prefijoCargo" value="Jefe Coordinador De Comunicación Organizacional">
      <input type="hidden" name="prefijoDiscapacidad" value="auditiva,fisica, visual">
      
      <!-- Aquí incluimos los ejercicios que deseas mostrar -->
      <?php
...
<script>
  function abrirEncuesta() {
    ...
    window.open('JefeCoordinadorDeComunicacionOrganizacionalEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
