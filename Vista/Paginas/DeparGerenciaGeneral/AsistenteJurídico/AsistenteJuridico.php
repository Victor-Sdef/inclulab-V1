...
<head>
  <meta charset="UTF-8">
  <title>Evaluación de Competencias - Asistente Juridico</title>
...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento Gerencia General (Asistente Jurídico)</h1>
  ...
  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Asistente Juridico">
...
<script>
  function abrirEncuesta() {
    ...
    window.open('AsistenteJuridicoEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
