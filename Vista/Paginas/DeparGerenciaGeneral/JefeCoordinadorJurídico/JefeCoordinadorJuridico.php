...
<head>
  <meta charset="UTF-8">
  <title>Evaluación de Competencias - Jefe Coordinador Jurídico</title>
...
<div class="header-container1">
  ...
  <br>
  <h1>Evaluación - Departamento Gerencia General (Jefe Coordinador Jurídico)</h1>
  ...
  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Asistente Jurídico">
...
<script>
  function abrirEncuesta() {
    ...
    window.open('JefeCoordinadorJuridicoEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
