...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento Gerencia General/Jefe Coordinador Jurídico)</h1>
        <form id="surveyForm" method="post" action="procesar_encuesta.php">
            ...
            <input type="hidden" name="cargo_departamento" value="JefeCoordinadorJurídico">
