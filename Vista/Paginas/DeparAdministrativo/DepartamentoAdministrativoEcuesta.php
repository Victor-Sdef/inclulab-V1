...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias(Departamento Administrativo)</title>
...
<body>
    <div class="survey-container">
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento Administrativo">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento Administrativo">
            <table>
                <thead>
                    <tr>
                        <th>Competencia</th>
