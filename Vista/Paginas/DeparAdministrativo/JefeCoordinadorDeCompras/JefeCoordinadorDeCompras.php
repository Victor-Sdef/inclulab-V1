...
<link rel="stylesheet" href="../../../assets/css/DepartamentoAdministrativo1/DepartamentoAdministrativo1.css">
...
<div class="header-container1">
 ...
 <br>
  <h1>Evaluación - Departamento Administrativo (Analista De Capacitación Y Desarrollo)</h1>
 

  <div class="form-container">
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
    
      <input type="hidden" name="prefijoDepartamento" value="Departamento Administrativo">
      <input type="hidden" name="prefijoCargo" value="Jefe de cordinador de compras">
      <input type="hidden" name="prefijoDiscapacidad" value="auditiva y fisica">


      <?php include '../../../../Controlador/DepartamentoAdministrativo/Preguntas/DepartamentoAdministrativoQuestion12345.php'; ?>
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoAdministrativoEcuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
...
<script src="../../../assets/js/DepartamentoAdministrativo1/DepartamentoAdministrativo1.js"></script>
</body>
</html>