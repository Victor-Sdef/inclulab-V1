...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias</title>
...
<body>
    <div class="survey-container">
        ...
        <br>
        <h1>Encuesta de Competencias (Departamento de Producción 1)</h1>
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento de Producción 1">
        
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento de Producción 1">
            ...
            <table>
                ...
                <tbody>
                    ...
                    $preguntas = [
                        ...
                        ['Trabajo en Equipo', [
                            '¿Ha tenido dificultad para trabajar en equipo y colaborar con otros?',
                            '¿Es capaz de compartir ideas y recursos con los demás para lograr un objetivo común?',
                            '¿Es capaz de aceptar críticas constructivas y aprender de ellas?',
                            '¿Es capaz de motivar y apoyar a sus compañeros de trabajo para lograr un ambiente positivo y productivo?',
                        ]],
                        ['Inspección de Productos, Instalación , Manejo de recursos materiales, Mantenimiento de equipos, Operación y Control, Reparación', [
                            '¿Ha tenido dificultad para planificar, identificar problemas y buscar la mejor solución? (por ejemplo, búsqueda de estrategias, asesoramiento o pedir ayuda.)',
                            '¿Puede recordar con facilidad información aprendida para realizar actividades y tareas laborales?',
                            '¿Ha tenido dificultades para manejar de forma adecuada sus responsabilidades asociadas con el rendimiento en la realización de tareas?',
                            '¿Ha tenido dificultades para reaccionar de manera inmediata frente a situaciones que pudieran ser peligrosas?',
                            '¿Ha tenido dificultades para discriminar formas, tamaños, contornos y detalles de determinados objetos de cerca utilizando los dos ojos?',
                            '¿Ha tenido dificultades para observar formas, tamaño, contornos y detalles de determinados objetos de lejos utilizando los dos ojos?',
                            '¿Ha tenido dificultades para observar formas, tamaños, contornos y detalles de determinados objetos de cerca utilizando primero el ojo derecho y luego el ojo izquierdo?',
                            '¿Ha tenido dificultades para observar formas, tamaños, contornos y detalles de determinados objetos de lejos utilizando primero el ojo derecho y luego el ojo izquierdo?',
                            ...
                            '¿Presenta dificultades para distinguir sonidos, su grado de intensidad y de donde provienen?',
                            '¿Presenta dificultades para identificar si el sonido proviene del lado derecho o el izquierdo de su oído?',
                            '¿Ha tenido dificultades para identificar y discriminar determinados olores como agradables y desagradables?',
                            '¿Ha presentado dificultades para sentir la textura (liso- rugoso), calidad (buena- mala), presión (poco- mucho) y temperatura (frio- caliente) de determinados objetos?',
                            '¿Ha tenido dificultades tales como entumecimiento, hormigueo, sensaciones anormales de cosquilleo, calor o frío al tocar determinados objetos?',
                            '¿Ha tenido dificultad para manejar, recoger, manipular, atrapar y soltar objetos, utilizando la mano, los dedos y varias partes de su cuerpo?',
                            '¿Dispone de toda la fuerza muscular en brazos, manos, piernas y pies para levantar objetos pesados?',
                            '¿Desde un lugar determinado puede desplazarse sin mayor inconveniente y realizar actividades que requieran de sentarse, pararse, tomar y dirigir ciertos objetos?',
                            '¿Presenta movimientos rápidos y pequeños en el cuerpo que no puede controlar (movimientos repetitivos en manos, brazos, piernas) como consecuencia de una afección en su salud?',
                            '¿Requiere de muletas, prótesis o silla de ruedas para desplazarse de un lugar a otro?',
                            '¿Presenta dificultades para mantener y pasar de una postura corporal a otra, por ejemplo; estar sentado, acostado, en cuclillas o arrodillado?',
                            '¿Presenta dificultades para trasladar materiales de un lugar a otro utilizando sus extremidades superiores e inferiores?',
                            '¿Tiene dificultad para andar, subir, bajar, tanto en distancias largas como cortas, sobre suelos inclinados, rectos o con obstáculos?',
                        ]],
                    ];
