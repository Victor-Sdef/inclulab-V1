...
<div class="header-container1">
  ...
  <h1>Evaluación - Departamento de Producción 1 (Supervisor de Mantenimiento Mecanico)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Supervisor de Mantenimiento Mecanico">
