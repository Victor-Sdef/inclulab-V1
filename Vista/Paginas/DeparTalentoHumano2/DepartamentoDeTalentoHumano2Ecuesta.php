...
<body>
    <div class="survey-container">
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento de Talento Humano 2">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento de Talento Humano 2">
