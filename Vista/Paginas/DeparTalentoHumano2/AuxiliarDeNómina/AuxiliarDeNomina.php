...
<body>
  ...
  <div class="top-bar">
    <a href="../../salir.php" class="logout-btn" aria-label="Cerrar sesión">Cerrar sesión</a>
  </div>

 <h2>Bienvenido/a, <?php echo htmlspecialchars($nombreUsuario); ?></h2>
  <br>
  <h1>Evaluación - Departamento de Talento Humano (Auxiliar De Nomina)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
     ...
     <input type="hidden" name="prefijoDepartamento" value="Departamento de Talento Humano 2">
      <input type="hidden" name="prefijoCargo" value="Auxiliar De Nómina">
      ...
      <?php 
         ...
         include '../../../../Controlador/DepartamentoHumano2/Preguntas/DeapartamentoHumano2Question_Ej1.php'; 
         include '../../../../Controlador/DepartamentoHumano2/Preguntas/DeapartamentoHumano2Question_Ej2.php'; 
         include '../../../../Controlador/DepartamentoHumano2/Preguntas/DeapartamentoHumano2Question_Ej3.php'; 
         include '../../../../Controlador/DepartamentoHumano2/Preguntas/DeapartamentoHumano2Question_Ej4.php'; 
         include '../../../../Controlador/DepartamentoHumano2/Preguntas/DeapartamentoHumano2Question_Ej5.php'; 
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoDeTalentoHumano2Ecuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
...
<script src="../../../assets/js/DepartamentoDeTalentoHumano2/DepartamentoDeTalentoHumano2.js"></script>
