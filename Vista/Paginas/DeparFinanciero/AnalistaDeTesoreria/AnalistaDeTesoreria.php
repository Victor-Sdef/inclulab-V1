...
<div class="header-container1">
  ...
  <h1>Evaluación - Departamento Financiero (Analista de tesoreria)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoCargo" value="Analista de tesoreria">
...
<script src="../../../assets/js/DepartamentoFinanciero/DepartamentoFinanciero.js"></script>
