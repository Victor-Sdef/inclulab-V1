...
<head>
  <meta charset="UTF-8">
  <title>Departamento Financiero</title>
...
<br>
  <h1>Evaluación - Departamento Financiero (Jefe coordinador de credito y cobranzas)</h1>
  ...
  <div class="form-container">
    ...
    <form id="form-ejercicios" method="POST" onsubmit="enviarFormulario(event)">
      ...
      <input type="hidden" name="prefijoDepartamento" value="Departamento financiero">
      <input type="hidden" name="prefijoCargo" value="Jefe coordinador de credito y cobranzas">
      <input type="hidden" name="prefijoDiscapacidad" value="auditiva y fisica ">
...
<script>
  function abrirEncuesta() {
    ...
    window.open('../DepartamentoFinancieroEncuesta.php', 'Encuesta', 'width=6000,height=800');
  }
</script>
