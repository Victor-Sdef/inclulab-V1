...
<head>
    <meta charset="UTF-8">
    <title>Encuesta de Competencias(Departamento Finciero)</title>
...
<body>
    <div class="survey-container">
        ...
        <input type="hidden" name="nombre_departamento" value="Departamento Financiero">
        <input type="hidden" name="cargo_departamento" value="Cargos del Departamento Financiero">
